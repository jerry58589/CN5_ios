...
//        NotificationCenter.default.post(name: notificationName, object: self, userInfo: ["login_ID" : "email.text!" , "login_password" : "22222" , "test" : 12345678 ])
//
...
//            self,
//            selector: #selector(FirstViewController.keyboardWillShow(_:)),
//            name: NSNotification.Name.UIKeyboardWillShow,
//            object: nil)
//        NotificationCenter.default.addObserver(
//            self,
//            selector: #selector(FirstViewController.keyboardWillHide(_:)),
...
//    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "send_loginData" { //sendData = Storyboard Segue id
            ...
            mainViewController.receiveData = email.text!
        }
    }
