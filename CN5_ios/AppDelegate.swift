...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func createMenuView() {
        ...
        let nvc: UINavigationController = UINavigationController(rootViewController: firstViewController)
        ...
        self.window?.backgroundColor = UIColor(red: 236/255.0, green: 238/255.0, blue: 241/255.0, alpha: 1.0)
